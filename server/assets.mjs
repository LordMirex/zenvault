...
const assetMeta = {
  ...
  cosmos: {
    ...
    withdrawFee: 0.1,
    confirmations: 'Block finality under 1 minute',
    tags: ['Layer 1', 'Interoperability', 'Staking'],
  },
  filecoin: {
    network: 'Filecoin',
    minimumDeposit: 0.5,
    minimumWithdrawal: 1,
    withdrawFee: 0.05,
    confirmations: '200 confirmations',
    tags: ['Storage', 'Web3', 'Native'],
  },
  vechain: {
    network: 'VeChain',
    minimumDeposit: 100,
    ...
    withdrawFee: 20,
    confirmations: '12 confirmations',
    tags: ['Enterprise', 'Supply Chain', 'Native'],
  },
  algorand: {
    network: 'Algorand',
    minimumDeposit: 5,
  ...
  stacks: {
    ...
    withdrawFee: 0.5,
    confirmations: '6 confirmations',
    tags: ['Bitcoin Layer 2', 'Smart Contracts', 'Native'],
  },
  'render-token': {
    network: 'Solana',
    minimumDeposit: 1,
